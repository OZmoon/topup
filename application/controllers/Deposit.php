...
class Deposit extends CI_Controller
{
    ...
    public function pro()
    {
        ...
        if ($mode == 'otomatis') {
          $cekPayment = $this->chanelCalculator($payment,10000);
          if ($cekPayment) {
          }else {
            exit();
          }
          ...
          if ($payment === 'BCA') {
              ...
              $dataRespone['Detail'] = '<p> Nomer : <b class="bg-warning text-dark">081336469236</b> A/N Septian zulfikar f. </p>';
          } elseif ($payment === 'OVO') {
              $dataRespone['Detail'] = '<p> Nomer : <b class="bg-warning text-dark">081336469236</b> A/N Septian zulfikar f. </p>';
          } elseif ($payment === 'SHOPEE') {
              $dataRespone['Detail'] = '<p> Nomer : <b class="bg-warning text-dark">081336469236</b> A/N JnSeel. </p>';
          }

          // $this->email->initialize($config);
          // $this->email->from('admin@mvstore.id', SITE_NAME);
          // $this->email->to('mvteam.sda@gmail.com');
          // $this->email->subject('You Have New Deposit | '.$inpuData['InvoiceId'].'  | '.SITE_NAME);
          // $message = $this->load->view('email/EmailDeposit', $inpuData, true);
