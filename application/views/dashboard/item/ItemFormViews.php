              ...
              <div class="form-group row mb-4">
                ...
                <div class="col-sm-12 col-md-7">
                  <select class="form-control" name="ProductCode">
                    <?php $dataProduct = $this->db->get('data_product')->result(); ?>
                    <?php foreach ($dataProduct as $d):
                      ...
                      ?>
                      <option <?php if ($page == 'edit') { if ($data->ProductCode == $d->ProductCode){ echo "selected"; } }  ?> value="<?php echo $d->ProductCode; ?>"><?php echo $d->ProductName.' | '.$d->ProductCode.' | '.$type.' | '.$api; ?></option>
                    <?php endforeach; ?>
                  </select>
                </div>
              </div>
