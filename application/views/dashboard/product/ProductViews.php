        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <a href="<?php echo base_url('dashboard/product/create'); ?>" style="border-radius:5px;" class="btn btn-info">Add Product</a>
              ...
              <a href="<?php echo base_url('dashboard/product/allnonaktif'); ?>" style="border-radius:5px;margin-left:5px;" class="btn btn-info">NonAktifkn Semua Produk</a>
            </div>
            <div class="card-body">
              <div class="table-responsive">
                ...
                <?php foreach ($data as $d):?>
                    ...
                    <tr>
                      ...
                      <td><img style="width:150px;" src="<?php echo $d->ProductImage; ?>"></td>
                      <td><?php if ($d->ProductType == 0) {
                          echo '<div class="bg-info text-center text-white rounded" style="widht:100%;">
                                                <p>MANUAL</p>
                                              </div>';
                      } else {
