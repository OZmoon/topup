        ...
        <div class="col-12">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="form-group row mb-4">
                <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Api</label>
                <div class="col-sm-12 col-md-7">
                  <select class="form-control" name="ProductApi">
                    <option <?php if ($page == 'edit') { if ($data->ProductApi == '0'){ echo "selected"; } }  ?> value="0">MANUAL</option>
                    <option <?php if ($page == 'edit') { if ($data->ProductApi == '1'){ echo "selected"; } }   ?> value="1">DIGIFLAZZ</option>
                  </select>
                </div>
              </div>
              <div class="form-group row mb-4">
              ...
              <div class="form-group row mb-4">
                <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Product Cek Link</label>
                <div class="col-sm-12 col-md-7">
                  <input type="text" class="form-control" name="ProductCek" value="<?php if ($page == 'edit') {echo $data->ProductCek;} ?>">
                </div>
              </div>
              <div class="form-group row mb-4">
                <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Thumbnail 500 * 500 <?php if ($page == 'edit'): ?>
