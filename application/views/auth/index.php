        ...
        <div class="col-12">
          <div class="card">
                ...
                <table class="table table-striped" id="table-1">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><?php echo "Rp " . number_format($user->Balance, 2, ',', '.');?></td>
                      <td>
                      ...
                      <td><?php echo anchor("dashboard/auth/edit_user/".$user->id, 'Edit', "class='btn btn-info'") ;?>
                        <?php echo anchor("api/gak/".$user->id, 'Add ApiKey', "class='btn btn-danger'") ;?>
                        <?php echo '<a href="'.base_url('dashboard/auth/addsaldo/'.$user->id.'').'" class="btn btn-success">Add Saldo</a>';?>
                      </td>
                    </tr>
										<?php endforeach;?>
                  </tbody>
           ...
           <!-- <p><?php echo anchor('dashboard/auth/create_user', lang('index_create_user_link'))?> | <?php echo anchor('dashboard/auth/create_group', lang('index_create_group_link'))?> | <a href="<?php echo base_url('dashboard/auth/mv') ?>">FLASH DATA</a> </p> -->
			...
			<p><a href="<?php echo base_url('dashboard/auth/create_user') ?>" class="btn btn-danger"> Create User </a> | <a href="<?php echo base_url('dashboard/auth/create_group') ?>" class="btn btn-danger">Create Grub Link</a> | <a href="<?php echo base_url('dashboard/auth/mv') ?>" class="btn btn-danger">FLASH DATA</a> </p>
    </div>
  </section>
</div>
