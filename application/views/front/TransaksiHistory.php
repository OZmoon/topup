        ...
        <div class="container">
          <div class="row mb-3">
            <div class="col-md-4 col-12 p-1">
              <div class="mvstyle py-auto rounded text-dark text-center">
                <h3 class="h3">Total Pembelian</h3>
                <p><?php echo "Rp " . number_format($totalPembelian, 2, ',', '.'); ?></p>
              </div>
            </div>
            <div class="col-md-4 col-12 p-1">
              <div class="mvstyle py-auto rounded text-dark text-center">
                <h3 class="h3">Pembelian Hari ini</h3>
                <p><?php echo "Rp " . number_format($pembelianHariIni, 2, ',', '.'); ?></p>
              </div>
            </div>
            <div class="col-md-4 col-12 p-1">
              <div class="mvstyle py-auto rounded text-dark text-center">
                <h3 class="h3">Total Deposit</h3>
                <p><?php echo "Rp " . number_format($totalDeposit, 2, ',', '.'); ?></p>
              </div>
            </div>
          </div>
          ...
          <div class="row align-items-stretch">
            <div class="col-md-12 ml-auto text-dark"  data-aos-delay="100">
                <h5 class="title-game bg-warning rounded" style="padding:10px;">Transaction History</h5>
